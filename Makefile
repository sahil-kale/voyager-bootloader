...
CC = gcc
CXX = g++
CFLAGS = -Wall -g -pedantic -Werror -I$(INC_DIR) -I$(CPPUTEST_HOME)/include -I$(MOCK_DIR) -DVOYAGER_UNIT_TEST -DVOYAGER_BOOTLOADER_MAX_RECEIVE_PACKET_SIZE=64 -I$(HOST_UTILS_DIR) --std=c99
CXXFLAGS = -Wall -g -pedantic -Werror -I$(INC_DIR) -I$(CPPUTEST_HOME)/include -I$(MOCK_DIR) -DVOYAGER_UNIT_TEST -DVOYAGER_BOOTLOADER_MAX_RECEIVE_PACKET_SIZE=64 -I$(HOST_UTILS_DIR) --std=c++11
